  ...
  return (
    <Provider store={store}>
      <div className="App bg-gray-400">
        ...
        <div>
          <div class="ml-auto mb-6 lg:w-[100%]">
        ...
        <div class="my-4 grid grid-cols-1 xl:gap-4 2xl:grid-cols-2">
          <div class="mb-4 h-full rounded-lg bg-white p-4 shadow lg:ml-4 sm:p-6">
          ...
          <div class="rounded-lg lg:mr-4 bg-white p-4 shadow sm:p-6 xl:p-8">
            ...
            <div class="block w-full overflow-x-auto">
              <table class="w-full border-collapse items-center bg-transparent">
                <thead>
                  <tr>
                    <th class="whitespace-nowrap border-l-0 border-r-0 bg-gray-50 px-4 py-3 text-left align-middle text-xs font-semibold uppercase text-gray-700">
                      Top Channels
                    </th>
                    <th class="whitespace-nowrap border-l-0 border-r-0 bg-gray-50 px-4 py-3 text-left align-middle text-xs font-semibold uppercase text-gray-700">
                      Users
                    </th>
                    <th class="min-w-140-px whitespace-nowrap border-l-0 border-r-0 bg-gray-50 px-4 py-3 text-left align-middle text-xs font-semibold uppercase text-gray-700"></th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                  <tr class="text-gray-500">
                    <th class="whitespace-nowrap border-t-0 p-4 px-4 text-left align-middle text-sm font-normal">
                      Organic Search
                    </th>
                    <td class="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs font-medium text-gray-900">
                      5,649
                    </td>
                      ...
                      <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                          <div class="h-2 w-full rounded-sm bg-gray-200">
                            <div class="h-2 rounded-sm bg-cyan-600 w-[30%]"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr class="text-gray-500">
                    ...
                    <td class="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs">
                      <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                          <div class="h-2 w-full rounded-sm bg-gray-200">
                            <div class="h-2 rounded-sm bg-orange-300 w-[24%]"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr class="text-gray-500">
                    ...
                    <td class="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs">
                      <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                          <div class="h-2 w-full rounded-sm bg-gray-200">
                            <div class="h-2 rounded-sm bg-teal-400 w-[18%]"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr class="text-gray-500">
                    ...
                    <td class="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs">
                      <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                          <div class="h-2 w-full rounded-sm bg-gray-200">
                            <div class="h-2 rounded-sm bg-pink-600 w-[12%]"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr class="text-gray-500">
                    ...
                    <td class="whitespace-nowrap border-t-0 p-4 px-4 align-middle text-xs">
                      <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                          <div class="h-2 w-full rounded-sm bg-gray-200">
                            <div class="h-2 rounded-sm bg-indigo-600 w-[9%]"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr class="text-gray-500">
                    <th class="whitespace-nowrap border-t-0 p-4 pb-0 text-left align-middle text-sm font-normal">
                      Email
                    </th>
                    <td class="whitespace-nowrap border-t-0 p-4 pb-0 align-middle text-xs font-medium text-gray-900">
                      456
                    </td>
                    <td class="whitespace-nowrap border-t-0 p-4 pb-0 align-middle text-xs">
                      <div class="flex items-center">
                        <span class="mr-2 text-xs font-medium">7%</span>
                        <div class="relative w-full">
                          <div class="h-2 w-full rounded-sm bg-gray-200">
                            <div class="h-2 rounded-sm bg-purple-500 w-[7%]"></div>
                          </div>
                        </div>
                      </div>
                    </td>
        ...
        <footer class="my-6 mx-4 rounded-lg bg-white p-4 shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8">
          ...
          <div class="flex space-x-6 sm:justify-center">
            <a href="_#" class="text-gray-500 hover:text-gray-900">
              <svg
                class="h-5 w-5"
                fill="currentColor"
                viewBox="0 0 24 24"
